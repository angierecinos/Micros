...
ISR_PCINT0: 
	...
	INC		R25					// R24 será un contador de la cant. de veces que lee el pin
	CPI		R25, 50				// Si ocurre 50 veces, ya pasó el tiempo para antirrebote
	BRNE	ISR_PCINT0
	SEI
	RETI

// Rutina de interrupción para aumentar display
ISR_TIMER0_OVF: 
	SBI		TIFR0, TOV0
...
CONTADOR: 
	...
	CPI		R17, 0x0A			// Se compara para ver si ya sumó 
